    ...
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ color, size }) => {
          ...
          if (route.name === 'Save') return <Feather name="bookmark" size={size} color={color} />;
          if (route.name === 'Account') return <FontAwesome name="user" size={size} color={color} />;
        },
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login" screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="keamanan" component={Keamananpage} />
        ...
        <Stack.Screen
          ...
          options={{
            ...
            headerStyle: { backgroundColor: "#2F5C9A" },
            headerTintColor: "#fff",
            headerTitleStyle: {
              fontSize: 18,
              fontWeight: "bold",
